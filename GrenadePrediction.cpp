...
void grenade_prediction::Paint()
{
	...
	if ((type) && path.size()>1)
	{
		...
		Red = Menu.Colors.GrenadePrediction[0] * 255;
		Green = Menu.Colors.GrenadePrediction[1] * 255;
		Blue = Menu.Colors.GrenadePrediction[2] * 255;
		...
		{
			draw::DrawFilledRectOutline(nadeEnd.x, nadeEnd.y, 20, 20, Color(255, 255, 255, 255));
